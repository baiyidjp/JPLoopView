...
- (void)viewDidLoad {
    ...
    self.loopView = [JPLoopView loopViewWithFrame:CGRectMake(20, 100, self.view.bounds.size.width-40, self.view.bounds.size.width*9.0/16) delegate:self placeholderImage:nil];
    ...
    self.loopView.isShowImageCornerRadius = YES;
    self.loopView.isShowImageMaskView = YES;
    self.loopView.layer.cornerRadius = 8;
    self.loopView.layer.masksToBounds = YES;
